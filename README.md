...
|D| [Interesting Integers](https://codingcompetitions.withgoogle.com/kickstart/round/00000000008cb33e/00000000009e73ea)| [Python3](./Round%20A/interesting_integers.py3) | precompute: _O(log(MAX_B) * (9log(MAX_B))^3)_<br>runtime: _O((9logB)^2)_ | _O(log(MAX_B) * (9log(MAX_B))^3)_ | Hard | | Counting, Memoization |
